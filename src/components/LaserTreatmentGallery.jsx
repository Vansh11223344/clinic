...
import './LaserTreatmentGallery.css';
...
const treatments = [
  {
    ...
    before: '/images/bearhair.png',
    after: '/images/aearhair.png',
...
const LaserTreatmentGallery = () => {
  ...
  return (
    <Box className="laser-treatment-gallery">
